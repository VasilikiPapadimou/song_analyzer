...
from schema import (ADDRESSEE_CATEGORIES, AGENCY_LEVELS, ARC_MOVEMENTS, CONFIDENCE_LEVELS, EMOTION_FAMILIES, EMOTION_ROLES, GRAMMATICAL_PERSONS, RESOLUTION_STATES, TEMPORAL_ORIENTATIONS, THEME_FAMILIES, THEME_ROLES)
